...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate for the savings account (as a percentage): ")) / 100
    ...
    cd_interest = float(input("Enter the annual interest rate for the CD account (as a percentage): ")) / 100
